...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final _pages = const [
    _Page(emoji: '🔍', title: 'Lost Something?',
      subtitle: 'Post your lost item and let your\ncampus community help you find it.',
      color: Color(0xFF1A73E8)),
    _Page(emoji: '📦', title: 'Found Something?',
      subtitle: 'Report found items and help reunite\nthem with their rightful owners.',
      color: Color(0xFF34A853)),
    _Page(emoji: '🤝', title: 'Safe Handoff',
      subtitle: 'Our dual-confirmation OTP system ensures\nitems are returned safely and securely.',
      color: Color(0xFF9C27B0)),
  ];

  void _goToSignup() => Navigator.pushReplacement(context,
    MaterialPageRoute(builder: (_) => const EmailSignupScreen(startOnSignIn: false)));
        ...
        child: Column(children: [
          ...
          Padding(
            ...
            child: ElevatedButton(
              ...
              child: Text(_page < _pages.length - 1 ? 'Next' : 'Create My Account'),
            ),
          ),
          const SizedBox(height: 32),
        ]),
