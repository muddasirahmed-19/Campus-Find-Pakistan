          ...
          IconButton(
            ...
            onPressed: () async {
              ...
              if (context.mounted) Navigator.pushAndRemoveUntil(context,
                MaterialPageRoute(builder: (_) => const PhoneAuthScreen()), (_) => false);
            },
          ),
        ],
      ),
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.check_circle_outline_rounded, color: AppColors.secondary, size: 56),
              ),
              const SizedBox(height: 24),
              Text('You are In! 🎉', style: AppTextStyles.headlineLarge),
              const SizedBox(height: 8),
              Text('Welcome, ${user?.displayName ?? user?.email ?? user?.phoneNumber ?? 'User'}!',
