...
<!-- GitHub autoplays GIFs inline automatically. Record a short screen capture,
     convert it to a GIF (e.g. using ezgif.com or ScreenToGif), save it as
     demo.gif in the repo root, and it will play automatically below. -->
